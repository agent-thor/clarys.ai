...
export function ChatHeader({userName}: { userName: string }) {
    ...
    return (
        <div className="w-full flex justify-between items-center">
            ...
            <div className="relative buttonShadow px-8 py-2 rounded-2xl flex flex-row gap-4">{/* onBlur={onClickOutside}*/}
                <button
                ...
                >
                    <span className="hidden sm:block text-[12px] leading-4">{userName}</span>
                    <img
                        src="/images/user.svg"
                        alt="User"
                        className="w-4 h-4"
                ...
                {menuOpen && (
                    ...
                    >
                        <ul className="py-1">
                            ...
                            <li className="px-8 py-4 text-disabled">
                                Connect Wallet
                            </li>
                            <li className="px-8 py-4 hover:underline cursor-pointer"
