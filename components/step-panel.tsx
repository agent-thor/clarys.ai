...
export default function TourPanel({
  ...
  const step1 = (
    <>
      <div className="self-stretch grow shrink basis-0 justify-start items-start gap-8 inline-flex">
      ...
      <div className="self-stretch grow shrink basis-0 justify-start items-start gap-8 inline-flex">
        <div className="grow shrink basis-0 self-stretch flex-col justify-start items-start gap-8 inline-flex">
          ...
          <div className="w-[480px]">
            ...
            <div className="text-primary text-[14px] font-normal font-clarys leading-6">
              Quickly access proposals, discussions and bounty submissions
              within categories.
            </div>
          </div>
        </div>
  ...
  return (
    <div
      className={`bg-transparent w-full flex-col flex-1 justify-between ${className}`}
    >
      <div className="text-gray-600 mb-6 flex flex-col flex-1">
        {steps[currentStep]}
      </div>
