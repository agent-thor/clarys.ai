...
const Footer: React.FC<FooterProps> = ({ singleRow = true }) => {
  ...
  const privacyPolicyContent = (
    ...
    <div className="self-stretch justify-between items-start inline-flex">
        <div className="text-center text-primary text-xs font-normal font-['Open Sans'] leading-3">Copyright ©2024 Clarys.AI. All rights reserved.</div>
    </div>
</div>*/
  ...
  const copyrightBar = (
    <div className="text-center text-primary text-[12px] font-normal font-['Open Sans'] leading-3">
      Copyright ©2024 Clarys.AI. All rights reserved.
    </div>
  );
